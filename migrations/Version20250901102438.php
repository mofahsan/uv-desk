 ...
 */
final class Version20250901102438 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE marketing_module ADD CONSTRAINT FK_3042F007FE54D947 FOREIGN KEY (group_id) REFERENCES uv_support_group (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE marketing_module DROP FOREIGN KEY FK_3042F007FE54D947');
        ...
        $this->addSql('DROP TABLE marketing_module');
